...
def convert_to_reviews(list):
    review_class_list = []
    for i in list:
        i_review = Review(i['business_name'], i['user_name'], i['rating'], i['text'])
        review_class_list.append(i_review)
        #print(i_review)
    return review_class_list
...
review_class_list = convert_to_reviews(raw_review_data)
