...
def deal_a_card(my_hand, your_hand, deck):
	...
	while deal_count < 1:
		...
		if (new_card not in my_hand.card_list) and (new_card not in your_hand.card_list):
...
face_list = ['2', '3', '4', '5', '6', '7', '8', '9', '10', 'Jack', 'Queen', 'King', 'Ace']
